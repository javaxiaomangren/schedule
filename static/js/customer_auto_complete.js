//<![CDATA[
var getElementsByClassName = function (searchClass, node, tag) {/* 兼容各浏览器的选择class的方法 */
...
addEvent.call(null,'load',function(){
    autoComplete.call( getElementsByClassName('autoComplete'), {/* 使用call或apply调用此方法 */
            source:["Jane","Anna","Alexa","Shammy","Jay","Meca","Cely","Lora","Ruth","Roda","Claude","Angel","Eri","Aileen","Phoebe","Aileen"],
